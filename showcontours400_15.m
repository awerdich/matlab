...
dt=10;%isochronal separation (10 frames = 5 ms)
range=400;%New

ioutputresolution=[1024,round(1024/matrixaspectratio)];%output image resolution [width, height]
...
setframeumwidth=15;%frame unit length (40)[um]. If zero, use entire frame
setframeumheight=15;
